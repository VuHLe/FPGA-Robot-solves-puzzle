...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {dout[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {dout[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {dout[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {dout[3]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {dout[4]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {dout[5]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {dout[6]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {dout[7]}];  # "LD7"
...
set_property PACKAGE_PIN R16 [get_ports {init_goal}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {start}];  # "BTNL"
set_property PACKAGE_PIN R18 [get_ports {reset}];  # "BTNR"
set_property PACKAGE_PIN T18 [get_ports {init_start}];  # "BTNU"
...
set_property PACKAGE_PIN H19 [get_ports {din[4]}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {din[5]}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {din[6]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {oled_sw}];  # "SW7"
